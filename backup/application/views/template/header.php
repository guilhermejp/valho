...
<link href="https://fonts.googleapis.com/css?family=Raleway:400,700,500,800,600" rel="stylesheet"> 
...
<link rel="stylesheet" type="text/css" href="<?=base_url('assets/css/ekko-lightbox.min.css');?>">
...
<nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?=base_url();?>"><img class="img-responsive" src="<?=base_url('assets/images/logo-valho.png');?>"/></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?=base_url('valho');?>">A VALHO</a></li>
            <li><a href="<?=base_url('agende_inspecao');?>"> VENDA SEU CARRO</a></li>
